...
class KafkaConsumer(_KafkaConfigMixin, Consumer):
    def __init__(
        ...
        topic: str | None = None,
        *,
        consumer_group_id_prefix: str = "karapace-autogenerated-",
        ...
        **params: Unpack[KafkaClientParams],
        ...
        if "group_id" not in params:
            params["group_id"] = self._create_group_id(consumer_group_id_prefix)
    ...
    @staticmethod
    def _create_group_id(prefix: str) -> str:
...
class AsyncKafkaConsumer:
    ...
    def __init__(
        ...
        **params: Unpack[KafkaClientParams],
        ...
        self._topic = topic
        self._consumer_group_id_prefix = consumer_group_id_prefix
    ...
    def _start(self) -> None:
        self.consumer = KafkaConsumer(
            ...
            topic=self._topic,
            consumer_group_id_prefix=self._consumer_group_id_prefix,
